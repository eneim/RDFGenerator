...
public class GmlPolygons implements Data {
	 ...
	 * @return 圧縮したポリゴンのリスト
	 */
	public static List<Polygon> getReduction(int reductionScale,
	...
	private static boolean equalsPolygon(Polygon p1, Polygon p2) {
		return p1.npoints == p2.npoints
				&& ((Arrays.equals(p1.xpoints, p2.xpoints) && Arrays.equals(
						p1.ypoints, p2.ypoints)) || (Arrays.equals(p1.xpoints,
						reverseArray(p2.xpoints)) && Arrays.equals(p1.ypoints,
						reverseArray(p2.ypoints))));
	}
