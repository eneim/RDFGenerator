...
public class RailroadInfo {
	...
	public RailroadInfo(int railwayType, int instituteType, String line,
			String company) {
	...
	public boolean isJrLine() {
		...
		return (this.instituteType == 1 || this.instituteType == 2)
				&& (this.railwayType == 11);
	}
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof RailroadInfo) {
			...
			ret = this.line.equals(info.line)
					&& this.company.equals(info.company)
					&& this.railwayType == info.railwayType
					&& this.instituteType == info.instituteType;
			// assert((this.line.equals(info.line) &&
			// this.company.equals(info.company) && !ret) ||
	...
	public String toString() {
		return String.format("[%d:%d] %s (%s)", this.railwayType,
				this.instituteType, this.line, this.company);
	}
