...
public class GeneralFileFilter extends FileFilter implements java.io.FileFilter {
	...
	public static void addRasterGraphicsFileFilter(JFileChooser chooser) {
		...
		chooser.addChoosableFileFilter(new GeneralFileFilter(new String[] {
				"jpg", "jpeg" }, "JPEG (*.jpg; *.jpeg)"));
		chooser.addChoosableFileFilter(new GeneralFileFilter("bmp",
				"BMP (*.bmp)"));
	...
	public static GeneralFileFilter getRasterGraphicsFileFilters() {
		return new GeneralFileFilter(new String[] { "jpg", "jpeg", "png",
				"bmp", "wbmp" }, "ラスタ画像 (*.jpg; *.jpeg; *.png; *.bmp; *.wbmp)");
	}
	 ...
	 *            ディレクトリを許可するかどうか
	 */
	public GeneralFileFilter(List<String> extensions, String description,
			boolean dir) {
