...
public class BusRouteInfo implements Data {
	...
	public String toString() {
		return String.format("[%02d] %s (%s)", this.type, this.line,
				this.operationCommunity);
	}

	@Override
	public int hashCode() {
		return this.type + this.line.hashCode()
				+ this.operationCommunity.hashCode();
	}
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof BusRouteInfo) {
			...
			ret = this.type == info.type && this.line.equals(info.line)
