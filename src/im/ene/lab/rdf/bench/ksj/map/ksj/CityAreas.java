...
import im.ene.lab.rdf.bench.ksj.map.Label;
...
public class CityAreas implements Label {
	...
	private void initBounds() {
		...
		this.bounds = new Rectangle(minX, minY, (int) (maxX - minX),
				(int) (maxY - minY));
	}
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof CityAreas) {
			...
			ret = this.info.equals(area.info)
					&& Arrays.equals(this.polygons, area.polygons);
		}
		return ret;
	}
}
