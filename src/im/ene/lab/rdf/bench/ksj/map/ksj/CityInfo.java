...
public class CityInfo {
	 ...
	 * 都道府県名
	 */
	public static final String[] PREF_NAME = new String[] { "", // 0
			"北海道", // 1
			"青森県", // 2
			"岩手県", // 3
			"宮城県", // 4
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof CityInfo) {
			...
			ret = this.aac == info.aac
					&& this.code == info.code
					&& ((this.sun == null && info.sun == null) || this.sun
							.equals(info.sun))
					&& ((this.con == null && info.con == null) || this.con
							.equals(info.con))
					&& ((this.cn2 == null && info.cn2 == null) || this.cn2
							.equals(info.cn2));
			// assert(((this.aac == info.aac) && ret) || ((this.aac != info.aac)
			// && !ret)) : this.toString() +" <=> "+ info.toString();
		}
		return ret;
	}
	...
	public String toString() {
		return String.format("%s(%d) / %s / %s / %s : %05d (%02d)",
				PREF_NAME[this.code], this.sun, this.con, this.cn2, this.aac,
				this.code);
	}
}
